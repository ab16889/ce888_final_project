...
best_svc_three_ling_count = __grid_search_model(create_union_model_svc, X_train, y_train_three, param_grid=param_grid_svc)
print(best_svc_three_ling_count.steps)
best_svc_three_ling_count.fit(X_train, y_train_three )
svc_three_pred = best_svc_three_ling_count.predict(X_test)
print(classification_report(y_true=y_test_three, y_pred=svc_three_pred))
print(confusion_matrix(y_true=y_test, y_pred=svc_three_pred))
#print(random_pred)
pickle.dump(best_svc_three_ling_count, open("best_svc_ling_count_three.p", "wb"))

##start Random forest grid search

best_random_three_ling_count = __grid_search_model(create_union_model_random, X_train, y_train_three, param_grid=param_grid_random)
print(best_random_three_ling_count.steps)
best_random_three_ling_count.fit(X_train, y_train_three )
random_three_pred = best_random_three_ling_count.predict(X_test)
print(classification_report(y_true=y_test_three, y_pred=random_three_pred))
print(confusion_matrix(y_true=y_test, y_pred=random_three_pred))
#print(random_pred)
pickle.dump(best_random_three_ling_count, open("best_random_ling_three_count.p", "wb"))

#start MPL grid search

best_mlp_three_ling_count = __grid_search_model(create_union_model_mlp, X_train, y_train_three, param_grid=param_grid_mlp)
print(best_mlp_three_ling_count.steps)
best_mlp_three_ling_count.fit(X_train, y_train_three )
mlp_three_pred = best_mlp_three_ling_count.predict(X_test)
print(classification_report(y_true=y_test_three, y_pred=mlp_three_pred))
print(confusion_matrix(y_true=y_test, y_pred=mlp_three_pred))
#print(random_pred)
pickle.dump(best_mlp_three_ling_count, open("best_mlp_ling_three_count.p", "wb"))

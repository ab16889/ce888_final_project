...
best_svc_two_ling = __grid_search_model(create_union_model_svc, X_train, y_train, param_grid=param_grid_svc)
print(best_svc_two_ling.steps)
best_svc_two_ling.fit(X_train, y_train )
svc_two_pred = best_svc_two_ling.predict(X_test)
print(classification_report(y_true=y_test, y_pred=svc_two_pred))
print(confusion_matrix(y_true=y_test, y_pred=svc_two_pred))
#print(random_pred)
pickle.dump(best_svc_two_ling, open("best_svc_ling_two.p", "wb"))

##start Random forest grid search

best_random_two_ling = __grid_search_model(create_union_model_random, X_train, y_train, param_grid=param_grid_random)
print(best_random_two_ling.steps)
best_random_two_ling.fit(X_train, y_train )
random_two_pred = best_random_two_ling.predict(X_test)
...
#print(random_pred)
pickle.dump(best_random_two_ling, open("best_random_ling_two.p", "wb"))

#start MPL grid search

best_mlp_two_ling = __grid_search_model(create_union_model_mlp, X_train, y_train, param_grid=param_grid_mlp)
print(best_mlp_two_ling.steps)
best_mlp_two_ling.fit(X_train, y_train )
mlp_two_pred = best_mlp_two_ling.predict(X_test)
print(classification_report(y_true=y_test, y_pred=mlp_two_pred))
print(confusion_matrix(y_true=y_test, y_pred=mlp_two_pred))
#print(random_pred)
pickle.dump(best_mlp_two_ling, open("best_mlp_ling_two.p", "wb"))
